...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-view { background: #8b5cf6; color: white; border: none; border-radius: 8px; padding: 6px 12px; font-size: 12px; text-decoration: none;}
        ...
        .btn-save { background: #8b5cf6; color: white; border: none; border-radius: 50px; padding: 10px 25px; font-weight: 600; }
        ...
        .page-link { color: #2e1065 !important; }
...
<script>
    ...
    <?php if($message): ?>
        ...
        Toast.fire({ icon: '<?php echo $message_type === 'success' ? 'success' : 'error'; ?>', title: '<?php echo addslashes($message); ?>' });
    <?php endif; ?>
</script>
</body>
</html>