...
<head>
    ...
    <style>
        ...
        .btn-view { background: #8b5cf6; color: white; border-radius: 8px; padding: 6px 12px; font-size: 12px; transition: 0.3s; border: none; }
        .btn-view:hover { background: #7c3aed; transform: translateY(-2px); color: white; }
        
        .btn-void { background: #ef4444; color: white; border-radius: 8px; padding: 6px 12px; font-size: 12px; transition: 0.3s; border: none; }
        .btn-void:hover { background: #dc2626; transform: translateY(-2px); color: white; }
        .btn-void:disabled { background: #fca5a5; cursor: not-allowed; transform: none; }
        
        .dataTables_length select { border-radius: 8px; border: 1px solid #e5e7eb; padding: 5px 30px 5px 12px !important; margin: 0 5px; }
...
<script> 
    ...
    function clearFilter() {
        ...
        $('.filter-btn').removeClass('active-filter dimmed');
        $('#filterBadge').fadeOut();
    }
